...
<link href="{{asset('resources/css/style copy.css')}}" rel="stylesheet"/>
<!-- font CSS -->
...
<!-- //calendar -->
<!-- //font-awesome icons -->
<script type="text/javascript" src="{{asset('resources/js/jquery2.0.3.min.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/js/raphael-min.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/js/morris.js')}}"></script>
<style>
</style>
</head>
<body>
